...
#define GIMBAL_YAW_MIN_ANGLE_DEG    -360.0f
#define GIMBAL_YAW_MAX_ANGLE_DEG     360.0f
#define GIMBAL_YAW_MAX_SPEED_RPM    200.0f

#define GIMBAL_PITCH_MIN_ANGLE_DEG  -360.0f
#define GIMBAL_PITCH_MAX_ANGLE_DEG   360.0f
#define GIMBAL_PITCH_MAX_SPEED_RPM   200.0f
